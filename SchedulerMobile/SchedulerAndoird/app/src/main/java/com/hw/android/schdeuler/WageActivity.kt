...
class WageActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnSearch.setOnClickListener {
            ...
            var wageList = wageManager.selectWageData(DataList.loginData.get(nameIndex).phone, year+"-0"+month+"-")
            ...
            try {
               rlsWage.apply {
                    ...
                    adapter = WageRvAdapter(wageList as ArrayList<WageData>)
                }
            }
            catch (e : Exception)
            {
